...
class TestIdentifyRemovableWorktrees:
    """Tests for identify_removable_worktrees function."""

    def test_basic_removal_single_worktree(self) -> None:
    ...
    def test_never_remove_root_worktree(self) -> None:
    ...
    def test_never_remove_target_worktree(self) -> None:
    ...
    def test_skip_worktrees_with_detached_head(self) -> None:
    ...
    def test_skip_worktrees_not_in_consolidation_range(self) -> None:
    ...
    def test_exclude_source_worktree_when_creating_new(self) -> None:
    ...
    def test_empty_result_when_no_removable_worktrees(self) -> None:
    ...
    def test_multiple_removable_worktrees(self) -> None:
...
class TestCreateConsolidationPlan:
    """Tests for create_consolidation_plan function."""

    def test_full_consolidation_plan(self) -> None:
    ...
    def test_partial_consolidation_plan(self) -> None:
    ...
    def test_plan_with_new_worktree_creation(self) -> None:
    ...
    def test_plan_validates_branch_argument(self) -> None:
    ...
    def test_immutable_plan_object(self) -> None:
