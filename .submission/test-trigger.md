...
This file exists to trigger the GitHub Actions workflow for testing the updated installation process.
...
Updated: 2025-11-21 - Using claude command with ANTHROPIC_API_KEY secret (with .plan/ folder copy)
