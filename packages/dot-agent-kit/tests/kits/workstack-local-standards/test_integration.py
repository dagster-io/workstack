...
def test_kit_manifest_loads_successfully() -> None:
...
def test_kit_has_expected_artifacts() -> None:
...
def test_kit_has_cli_commands() -> None:
...
def test_command_file_is_importable() -> None:
...
def test_skill_file_is_readable() -> None:
...
def test_hook_configuration_is_valid() -> None:
...
def test_command_definition_is_valid() -> None:
