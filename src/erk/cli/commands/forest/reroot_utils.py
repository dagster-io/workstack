...
def create_reroot_plan(
    ...
    Args:
        forest: ForestData to reroot
        graphite: Graphite for stack information
        git: Git for git operations
    ...
    stack = graphite.get_branch_stack(git, repo_root, first_branch)
