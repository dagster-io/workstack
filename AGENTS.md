...
| Creating or executing implementation plans                       | → Use /erk:save-context-enriched-plan, /erk:create-plan-issue-from-plan-file, /erk:create-wt-from-plan-file, /erk:implement-plan, /erk:implement-plan-issue, erk submit |
...
| **Agentic patterns**         | [docs/agentic-engineering-patterns/](docs/agentic-engineering-patterns/) - Pattern catalog (WHAT/WHY focus) |
