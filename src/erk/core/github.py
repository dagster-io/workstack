...
Architecture:
- GitHub: Abstract base class defining the interface
- RealGitHub: Production implementation using gh CLI
- DryRunGitHub: Dry-run wrapper that delegates reads, prints write intentions
