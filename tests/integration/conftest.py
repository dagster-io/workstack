...
def git_ops(
    ...
    if git_ops_impl == "real":
        ...
        git_ops = FakeGitOps(
            ...
            worktrees={repo: [WorktreeInfo(path=repo, branch="main", is_main=True)]},
...
def git_ops_with_worktrees(
    ...
    if git_ops_impl == "real":
        ...
        git_ops = FakeGitOps(
            ...
            worktrees={
                repo: [
                    WorktreeInfo(path=repo, branch="main", is_main=True),
                    WorktreeInfo(path=wt1, branch="feature-1", is_main=False),
                    WorktreeInfo(path=wt2, branch="feature-2", is_main=False),
                ]
            },
    ...
    if git_ops_impl == "real":
        ...
        git_ops = FakeGitOps(
            ...
            worktrees={
                repo: [
                    WorktreeInfo(path=repo, branch="main", is_main=True),
                    WorktreeInfo(path=wt_detached, branch=None, is_main=False),  # Detached HEAD
                ]
            },
