...
- command: commands/erk/save-plan.md, commands/erk/save-raw-plan.md, commands/erk/create-wt-from-plan-file.md, commands/erk/implement-plan.md, commands/erk/fix-merge-conflicts.md
