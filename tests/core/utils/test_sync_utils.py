...
class TestIdentifyDeletableWorktrees:
    """Tests for identify_deletable_worktrees function."""

    def test_identifies_merged_pr(self) -> None:
    ...
    def test_identifies_closed_pr(self) -> None:
    ...
    def test_skips_root_worktree(self) -> None:
    ...
    def test_skips_detached_head(self) -> None:
    ...
    def test_skips_non_managed_worktrees(self) -> None:
    ...
    def test_skips_open_prs(self) -> None:
    ...
    def test_skips_branches_without_pr_status(self) -> None:
    ...
    def test_skips_merged_pr_without_number(self) -> None:
    ...
    def test_identifies_multiple_deletable_worktrees(self) -> None:
    ...
    def test_empty_worktrees_list(self) -> None:
    ...
    def test_empty_pr_statuses(self) -> None:
    ...
    def test_worktree_name_extraction(self) -> None:
