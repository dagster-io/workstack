...
def test_split_creates_worktrees_and_forest() -> None:
    ...
    with erk_inmem_env(runner) as env:
        ...
        graphite_ops = FakeGraphiteOps(stacks={"feat-1": ["main", "feat-1", "feat-2", "feat-3"]})
...
def test_split_with_up_flag() -> None:
    ...
    with erk_inmem_env(runner) as env:
        ...
        graphite_ops = FakeGraphiteOps(stacks={"feat-2": ["main", "feat-1", "feat-2", "feat-3"]})
...
def test_split_dry_run() -> None:
    ...
    with erk_inmem_env(runner) as env:
        ...
        graphite_ops = FakeGraphiteOps(stacks={"feat-1": ["main", "feat-1", "feat-2"]})
