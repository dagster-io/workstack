"""Tests for Forest implementations."""

from pathlib import Path

from erk.core.forest_ops import FakeForest, RealForest
from erk.core.forest_types import Forest, ForestMetadata, RerootState


def test_fake_forest_ops_load_empty() -> None:
    """Test loading from empty FakeForest."""
    ops = FakeForest()
